...
<style media="print">
	...
	<body>
		...
		{{--</tr>--}}
		<tr>
		    <td style="font-size:18pt;">申报学习班报表</td>
		</tr>
		</table>
		<table class="context">
		  <thead>
		  <tr>
		    ...
		    <td style="width:20%;">学习班名称</td>
		    <td style="width:34%;">学科</td>
		    <td style="width:9%;">学习班负责人</td>
		  </tr>
		  </thead>
		  <tbody>
		  @if(!empty($data))
		  ...
		  <tr>
		    <td>{{ $tr->sn }}</td>
		    <td>{{ $tr->name }}</td>
		    <td>{{ !$tr->training_subject ?: $tr->trainingSubjectObject->name }}</td>
		    <td>{{ $tr->leader }}</td>
		  </tr>
		  @endforeach
		  @endif
