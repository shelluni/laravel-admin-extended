...
<head>
    ...
    <link rel="stylesheet" href="{{ admin_asset("/vendor/laravel-admin/nestable2/jquery.nestable.css") }}">
    ...
    <link rel="stylesheet" href="{{ admin_asset("/vendor/laravel-admin/AdminLTE/dist/css/AdminLTE.min.css?20180116") }}">
    <link rel="stylesheet" href="{{ admin_asset("/vendor/laravel-admin/bootstrap-treeview/bootstrap-treeview.css") }}">
...
<body class="hold-transition {{config('admin.skin')}} layout-top-nav">
<div class="wrapper">

    @include('admin_extended::partials.header')
...
<!-- REQUIRED JS SCRIPTS -->
<script src="{{ admin_asset ("/vendor/laravel-admin/bootstrap-treeview/bootstrap-treeview.js") }}"></script>
<script src="{{ admin_asset ("/vendor/laravel-admin/nestable2/jquery.nestable.js") }}"></script>
